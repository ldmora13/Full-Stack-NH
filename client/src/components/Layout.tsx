            ...
            >
                <div className="p-6 flex items-center justify-between h-20 relative">
                    ...
                    <button
                        ...
                        className={clsx(
                            "hidden lg:flex items-center justify-center p-1.5 rounded-lg text-blue-400 hover:text-white hover:bg-blue-500/10  transition-colors absolute -right-3 top-8 border border-blue-500/20 bg-blue-500/10 shadow-xl"
                        )}
                    >
