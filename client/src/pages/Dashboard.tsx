        ...
        <Layout>
            ...
            <div className="glass rounded-3xl p-8">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <Link to="/tickets" className="text-sm font-medium text-blue-400 hover:text-emerald-300 transition-colors py-2 px-4 rounded-lg hover:bg-blue-500/10">
                        {t('common.view_all')}
                    </Link>
                </div>
                ...
                <div className="space-y-3">
                    {recentActivity.length === 0 ? (
                        <div className="text-center py-12 bg-white/5/30 rounded-2xl border border-white/10/50 dashed-border">
                        ...
                        recentActivity.map((ticket) => (
                            <Link
                                ...
                                className="flex items-center justify-between p-4 bg-white/5/40 rounded-2xl border border-white/10/50 hover:border-blue-500/30 hover:bg-white/5/60 transition-all duration-300 cursor-pointer group"
                            >
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="text-xs font-mono font-medium px-3 py-1.5 rounded-lg bg-black/30 text-slate-500 border border-white/10 group-hover:text-blue-400 group-hover:border-blue-500/30 transition-colors">
