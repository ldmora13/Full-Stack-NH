-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CLIENT', 'ADMIN', 'ADVISOR');
...
-- AddForeignKey
ALTER TABLE "Ticket" ADD CONSTRAINT "Ticket_advisorId_fkey" FOREIGN KEY ("advisorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
